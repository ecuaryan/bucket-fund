...
/**
 * Fingerprint glyph (filled, Material Design "fingerprint"). A solid filled
 * icon stays unmistakably a fingerprint even at small sizes inside an input.
 */
export default function FingerprintIcon({ className = 'h-6 w-6' }: Props) {
  return (
    <svg
